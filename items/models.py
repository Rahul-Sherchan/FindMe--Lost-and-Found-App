...
class Item(models.Model):
    ...
    is_resolved = models.BooleanField(default=False, help_text="Item marked as resolved/returned")
    reward_paid = models.BooleanField(default=False, help_text="Reward payment completed via Khalti")
...
class Claim(models.Model):
    ...
    message = models.TextField(help_text="Message to the owner explaining how you found the item or why it belongs to you")
    proof_details = models.TextField(blank=True, default='', help_text="Provide text details proving ownership")
